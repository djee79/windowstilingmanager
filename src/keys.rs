...
pub const ACTIONS: &[(&str, &str, &str)] = &[
    ...
    ("toggle_split", "alt+v", "Flip split direction (side-by-side / stacked)"),
    ...
    ("overview", "alt+backtick", "Workspace overview (Exposé)"),
    ("window_switcher", "alt+w", "Fuzzy window switcher (all workspaces)"),
    ("scratchpad", "alt+s", "Toggle the scratchpad overlay"),
    ("cycle_scratchpad", "alt+n", "Focus next scratchpad window"),
    ("send_scratchpad", "alt+shift+s", "Send window to / pull from the scratchpad"),
    ("pin_scratchpad", "alt+ctrl+s", "Pin/unpin app: its windows always open in the scratchpad"),
...
pub fn action_to_command(action: &str, digit: Option<usize>) -> Option<Command> {
    Some(match action {
        ...
        "window_switcher" => Command::WindowSwitcher,
        "scratchpad" => Command::ScratchToggle,
        "cycle_scratchpad" => Command::ScratchCycle,
        "send_scratchpad" => Command::ScratchSend,
        "pin_scratchpad" => Command::PinScratchpad,
